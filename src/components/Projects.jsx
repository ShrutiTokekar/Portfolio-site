...
const projects = [
  ...
  { id: 2, name: "Refundly - Microservice", description: "A real-time return fraud detection platform for e-commerce systems built with a Go microservice architecture and a C++ administrative dashboard.", techStack: ["Go", "Gin", "C++", "Drogon", "PostgreSQL", "Redis", "Docker"], link: "https://github.com/shrutitokekar/Refundly", year: "2026", category: "Backend"},
  { id: 3, name: "Skinthesis", description: "Marketing website for Skinthesis, a biotech beauty startup — built with Next.js 14, TypeScript, and Tailwind CSS. Converted from a static HTML/CSS/JS site featuring smooth scroll animations, interactive product UI, and a fully responsive design.", techStack: ["Next.js 14", "TypeScript", "Tailwind CSS", "React"], link: "https://github.com/shrutitokekar/Skinthesis", year: "2026", category: "Frontend"},
  { id: 4, name: "AI PersonalFinancial Assistant: Zenty", description: "A Full Stack AI based financial assistant made with python as the backend and nextjs as the frontend. It provides users with personalized financial insights, budgeting tools, and real-time market updates through an intuitive conversational interface.", techStack: ["Next.js", "TypeScript", "Tailwind CSS", "Python", "OpenAI API"], link: "https://github.com/shrutitokekar/AI-Personal-finance-Zenty", year: "2025", category: "Full Stack" },
  { id: 5, name: "Space invaders game", description: "A classic space invaders game implemented in C++ using the SDLC library, featuring multiple levels and game state machine.", techStack: ["C++", "SDL", "Game Development"], link: "https://github.com/shrutitokekar/space-invaders", year: "2024", category: "Systems" },
  { id: 6, name: "Steganography in BMP", description: "C program that hides and extracts secret messages within BMP images using least significant bit manipulation.", techStack: ["C", "File I/O", "Binary"], link: "https://github.com/shrutitokekar/steganography-in-BMP", year: "2024", category: "Systems" },
  { id: 7, name: "Preemptive SJF Scheduler", description: "OS scheduling algorithm implementation in C with I/O handling, process queues, context switching, and deadline tracking.", techStack: ["C", "Linux", "OS Concepts"], link: "https://github.com/shrutitokekar/Preemptive-SJF-Scheduler", year: "2024", category: "Systems" },
  { id: 8, name: "Music Analyzer Backend", description: "PHP-based backend for a music analytics platform with RESTful API endpoints, Docker containerization, and MySQL.", techStack: ["PHP", "MySQL", "Docker", "REST API"], link: "https://github.com/shrutitokekar/music-analyzer-backend", year: "2023", category: "Backend" },
  { id: 9, name: "Student Management System", description: "Java-based system to manage student records with full CRUD operations and data visualization.", techStack: ["Java", "MySQL"], link: "https://github.com/shrutitokekar/student-management-system", year: "2023", category: "Backend" },
  { id: 10, name: "Online Shopping System", description: "A Java application designed to provide an interactive platform for online shopping. Users can register, browse products, manage their shopping carts, and process orders through a console-based interface.", techStack: ["Java", "MySQL"], link: "https://github.com/shrutitokekar/OnlineShoppingSystem", year: "2022", category: "Backend" },
  { id: 11, name: "TO-do List", description: "Simple to-do list built using HTML, CSS, and JavaScript that allows users to add, edit, and delete tasks with a clean interface.", techStack: ["HTML", "CSS", "JavaScript"], link: "https://github.com/shrutitokekar/Todolist", year: "2022", category: "Frontend" },
];
