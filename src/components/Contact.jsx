...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      "service_akv2ulp",     // Replace with your EmailJS service ID
      "template_xy51y5g",    // Replace with your EmailJS template ID
      {
        from_name: formData.name,
        from_email: formData.email,
        message: formData.message,
      },
      "6pl2_pSAXXV6qKFf9"         // Replace with your EmailJS public key
    )
    .then(() => {
  ...
  return (
    <section className="min-h-screen rounded bg-purple-100 flex items-center justify-center py-20 px-6">
      <motion.form
